...
//     <>
//       {GlobalState.isAdmin && (
//         <Button variant="outlined" onClick={handleClickOpen} marginTop={"200px"} >
//           הוסף שירות
//         </Button>
//       )}
...
//       <Box display="flex" flexDirection="column" alignItems="center" bgcolor="#e0e0e0" p={2} marginTop={"300px"}>
